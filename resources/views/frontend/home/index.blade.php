  ...
  <div class="page-section">
    <div class="container">
      ...
      <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
        @foreach($doctor as $add_doctors)
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="{{ asset('/doctor/'.$add_doctors->image) }}" alt="">
              <div class="meta">
            ...
            <div class="body">
              <p class="text-xl mb-0">{{ $add_doctors->name }}</p>
              <span class="text-sm text-grey">{{ $add_doctors->speciality }}</span>
            </div>
          </div>
        </div>
      @endforeach
        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            <select name="doctor"  id="departement" class="custom-select">
             @foreach ($doctor as $add_doctors)
            <option value="{{ $add_doctors->name }}">{{ $add_doctors->name }}--speciality--{{ $add_doctors->speciality }}</option>
            @endforeach 
            </select>
          </div>
